...
<!-- Last updated on ${brazilianTime.toString()} -->
<i>Last updated on ${brazilianTime.getDate()}${brazilianTime.getDate() === 1 ? "st" : brazilianTime.getDate() === 2 ? "nd" : brazilianTime.getDate() === 3 ? "rd" : "th"} ${["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"][brazilianTime.getMonth()]} ${brazilianTime.getFullYear()} at ${brazilianTime.getHours()}:${brazilianTime.getMinutes().toString().padStart(2, '0')}:${brazilianTime.getSeconds().toString().padStart(2, '0')} using magic</i> ✨`;
